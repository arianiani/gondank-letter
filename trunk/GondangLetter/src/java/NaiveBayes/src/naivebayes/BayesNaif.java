...
//                        System.out.println(" "+Integer.parseInt(ins.instance(i).toString(16)));
    ...
    public void preprosesDis (Instances ins) throws Exception {
        ...
        //matprob(prepIns);
        System.out.println("jlh att "+prepIns.numAttributes());
//        for(int i = 0; i<prepIns.numAttributes(); i++){
//            System.out.println("yang baru "+ prepIns.instance(0).toString(i));            
//            //'\'(-inf-1.5]\'','\'(1.5-3]\'','\'(3-4.5]\'','\'(4.5-6]\'','\'(6-7.5]\'','\'(7.5-9]\'','\'(9-10.5]\'','\'(10.5-12]\'','\'(12-13.5]\'','\'(13.5-inf)\''
//        }
        System.out.println("jenisnya "+prepIns.instance(0).classValue()+" lagi");
